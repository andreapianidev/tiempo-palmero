 ...
 *
 * En iOS y Android no hay origen: la app es un binario y los datos siguen
 * viviendo en el despliegue de producción. La aplicación móvil llama una vez a
 * `setDataOrigin()` al arrancar y el resto del núcleo —`api.ts`, el DEM, las
 * capas, la red de guaguas— no se entera de nada.
 *

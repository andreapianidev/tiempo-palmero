 ...
 * los tres.
 *
 * Esta tabla es gemela de `mobile/src/components/sheet/snaps.ts`, la de la app
 * nativa, y no está compartida a propósito: allí los márgenes seguros los da
 * `react-native-safe-area-context` y aquí salen de `env(safe-area-inset-*)`
 * medido en el navegador. Lo que sí es el mismo número es el 0,46 de la mitad y
 * el orden de los escalones, que es lo que hace que las dos se sientan igual.
 */
 ...
 * movido poco. Es el mismo criterio que el prototipo de iOS.
 */
